...
def parse_options(is_train=True):
    print('Parsing options..', flush=True)
    ...
    print('Fnished parsing options..', flush=True)
...
def init_loggers(opt):
    ...
    logger = get_root_logger(
        logger_name='basicsr', log_level=logging.DEBUG, log_file=log_file)
...
def main():
    ...
    epoch = start_epoch
    with tqdm(total=total_iters) as progress:
        while current_iter <= total_iters:
            ...
            while train_data is not None:
                ...
                current_iter += 1
                progress.update(1)  # Manually update the progress bar
